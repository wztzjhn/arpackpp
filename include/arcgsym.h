...
class ARluSymGenEig:
 ...
 // c.2) Constructors and destructor.
  ...
  ARluSymGenEig(MKL_INT nevp, ARchSymMatrix<ARFLOAT>& A,
                ARchSymMatrix<ARFLOAT>& B, const std::string& whichp = "LM",
                MKL_INT ncvp = 0, ARFLOAT tolp = 0.0, MKL_INT maxitp = 0,
                ARFLOAT* residp = NULL, bool ishiftp = true);
  // Long constructor (regular mode).

  ARluSymGenEig(char InvertModep, MKL_INT nevp, ARchSymMatrix<ARFLOAT>& A,
...
ARluSymGenEig(MKL_INT nevp, ARchSymMatrix<ARFLOAT>& A,
              ARchSymMatrix<ARFLOAT>& B, const std::string& whichp, MKL_INT ncvp,
