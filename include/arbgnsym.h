...
class ARluNonSymGenEig:
 ...
 // c.2) Constructors and destructor.
  ...
  ARluNonSymGenEig(MKL_INT nevp, ARbdNonSymMatrix<ARFLOAT, ARFLOAT>& A,
...
ARluNonSymGenEig(MKL_INT nevp, ARbdNonSymMatrix<ARFLOAT, ARFLOAT>& A,
                 ARbdNonSymMatrix<ARFLOAT, ARFLOAT>& B, const std::string& whichp, MKL_INT ncvp,
...
ARluNonSymGenEig(MKL_INT nevp, ARbdNonSymMatrix<ARFLOAT, ARFLOAT>& A,
                 ARbdNonSymMatrix<ARFLOAT, ARFLOAT>& B, char partp, 
                 ARFLOAT sigmaRp, ARFLOAT sigmaIp, const std::string& whichp, MKL_INT ncvp, 
                 ARFLOAT tolp, MKL_INT maxitp, ARFLOAT* residp, bool ishiftp)
